...
//        registerButton.click();
    ...
    @When("I populate only the mandatory fields firstname as {string}, lastname as {string}, email as {string}, password and ConfirmPassword as {string}")
    public void i_populate_only_the_mandatory_fields_firstname_as_lastname_as_email_as_password_and_confirm_password_as(String fName, String lName, String email, String pWord) throws InterruptedException {
        // Write code here that turns the phrase above into concrete actions
