...
public class NopCommerceLoginStepDef extends BaseUtil {
    ...
    {
        assertThat(base.driver.findElement(By.cssSelector("span[class = 'cart-qty']")).getText(), is(equalTo("(0)")));
    ...
    {
        assertThat(base.driver.findElement(By.xpath("//span[@id='Email-error']")).isDisplayed(), is(true));
//        assertThat(base.driver.findElement(By.xpath("//span[@id='Email-error']")).getText(), is(equalTo("")));
